...
func TestServiceCreate(t *testing.T) {
...

	{
		...
		cases := map[string]api.RESTServiceConfig{
			"g1":            {"g1", "", nil, nil, nil, nil},
			"g1.default":    {"g1", "default", nil, nil, nil, nil},
			"external":      {"external", "", nil, nil, nil, nil},
			"nodes":         {"nodes", "", nil, nil, nil, nil},
			"nv.g2.default": {"nv.g2", "default", nil, nil, nil, nil},
			"g2.default":    {"g2", "default", nil, &modeMonitor, nil, nil},
			"sys.default":   {"sys", "default", nil, nil, nil, &notScored},
		}
		...
		cases = map[string]api.RESTServiceConfig{
			...
			"g1.default": {"g1", "default", nil, nil, nil, nil},
			".":          {"", "", nil, nil, nil, nil},
			".default":   {"", "default", nil, nil, nil, nil},
			"g2":         {"g2", "", nil, &modeEmpty, nil, nil},
			"g3.default": {"g2", "default", nil, &modeWrong, nil, nil},
		}
