					...
					Containers: []corev1.Container{
						corev1.Container{
							...
							VolumeMounts: []corev1.VolumeMount{
								corev1.VolumeMount{
									Name:      "migration-cert",
									MountPath: "/etc/neuvector/certs/internal/migration/tls.crt",
									ReadOnly:  true,
									SubPath:   "cert.pem",
								},
								corev1.VolumeMount{
									Name:      "migration-cert",
									MountPath: "/etc/neuvector/certs/internal/migration/tls.key",
									ReadOnly:  true,
									SubPath:   "key.pem",
								},
								corev1.VolumeMount{
									Name:      "migration-cert",
									MountPath: "/etc/neuvector/certs/internal/migration/ca.crt",
									ReadOnly:  true,
									SubPath:   "ca.cert",
								},
							},
						...
						corev1.Volume{
							...
							VolumeSource: corev1.VolumeSource{
								Secret: &corev1.SecretVolumeSource{
									DefaultMode: &mode,
									SecretName:  "neuvector-migration-secret",
								},
							},
						},
					},
